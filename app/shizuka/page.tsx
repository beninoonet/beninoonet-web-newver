...
export const metadata: Metadata = {
    title: "Shizuka - Beninoonet",
    description: "Shizuka est un serveur discord calme et respectueux pour discuter, partager et se détendre.",
}
export default function ShizukaPage() {
    return (
        <div className="min-h-screen flex  py-25 justify-center bg-linear-to-br from-[#0f056b]/85 to-[#130c4d]/70">
            ...
            <Image loading="eager" src="/img/Shizuka_3.gif" alt="Shizuka Logo" width={300} height={300} className="rounded-3xl shadow-lg" />
           ...
           {/*  <Link aria-disabled href="/" target="_blank" className="bg-[#0f056b] hover:bg-[#130c4d]/50 text-white font-bold py-3 px-8 rounded-2xl  transition-colors duration-300">
